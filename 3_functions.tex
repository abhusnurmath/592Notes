...
Equivalence relations on a set $A$ have this very nice property that you can use them to partition a set. Given any equivalence relation $R$ on $A$, take each element  $a \in A$ in turn. Form the equivalence class of $a$ generally denoted by $[a] = \{x \in A | xRa\}$. These equivalence classes can then be shown to form a partition of $A$.
