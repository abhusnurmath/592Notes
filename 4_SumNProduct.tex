...
\paragraph{Example}
Consider a wedding picture of 6 people, there are 10 people in total including the bride and groom. How many possibilities are there if the bride must be in the picture? Remember that pictures are considered different if different people are placed in different locations.

The bride can be picked first and put into any of 6 positions.

Then for the other 5 positions to be filled, the first of them will have 9 possibilities (all except the bride), the next one 8 and so on.
